...
public class BusInfo extends AppCompatActivity {
    ...
    void checkRunTimePermission() {
        ...
        int hasFineLocationPermission = ContextCompat.checkSelfPermission(BusInfo.this,
                Manifest.permission.ACCESS_FINE_LOCATION);
        int hasCoarseLocationPermission = ContextCompat.checkSelfPermission(BusInfo.this,
        ...
        if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED &&
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(BusInfo.this, REQUIRED_PERMISSIONS[0])) {

                // 3-2. 요청을 진행하기 전에 사용자가에게 퍼미션이 필요한 이유를 설명해줄 필요가 있습니다.
                Toast.makeText(BusInfo.this, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.", Toast.LENGTH_LONG).show();
                // 3-3. 사용자게에 퍼미션 요청을 합니다. 요청 결과는 onRequestPermissionResult에서 수신됩니다.
                ActivityCompat.requestPermissions(BusInfo.this, REQUIRED_PERMISSIONS,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gotoHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myintent = new Intent(BusInfo.this, Menu.class);
        ...
        //mwv.getSettings().setGeolocationDatabasePath(Context.getFilesDir().getPath());
        ...
        mwv.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, String message, final android.webkit.JsResult result) {
                ...
                new AlertDialog.Builder(BusInfo.this)
        ...
        mwv.loadUrl("https://killog.shop/busstop/search/"); // 웹뷰에 표시할 웹사이트 주소, 웹뷰 시작
    }
